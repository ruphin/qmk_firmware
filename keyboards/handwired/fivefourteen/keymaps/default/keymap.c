...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |-----------------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+--------+-----------------|
  * | LCTRL  | LGUI   | LALT   | \      | /      | SPACE  . XXXXXX | [      | ]      |        | LEFT   | RIGHT  | UP     | DOWN   |
  * '-----------------------------------------------------------------------------------------------------------------------------'
  */

  [_RP] = { /* RUPHIN */
    { F(0),    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC },
    { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, TG(_NP) },
    ...
    { KC_LCTL, KC_LGUI, KC_LALT, KC_BSLS, KC_SLSH, KC_SPC,  KC_SPC,  KC_LBRC, KC_RBRC, _______, KC_LEFT, KC_RGHT, KC_UP,   KC_DOWN },
  },
